    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6 col-xl-5">
        <div class="card overflow-hidden">
          <div class="bg-soft-theme-primary">
            <div class="row">
              <div class="col-7">
                <div class="text-theme-primary p-4">
                  <h5 class="text-theme-primary">Welcome Back !</h5>
        ...
        <div class="mt-5 text-center">
          <p>
            © {{new Date().getFullYear()}} FMSBM. Crafted with
            <i class="mdi mdi-heart text-danger"></i> by Mehedee Alam
          </p>
        </div>
        <!-- end row -->
      </div>
